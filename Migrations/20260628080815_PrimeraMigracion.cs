        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NombreCat = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Gramaje = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Estado = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Destacado = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuProductoViewModel", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "PedidosCompleto",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PedidosCompleto", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "ProductosCompleto",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    Destacado = table.Column<bool>(type: "bit", nullable: false),
                    FechaCreacion = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PrecioMinimo = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    PrecioMaximo = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CantidadGramajes = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductosCompleto", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActividadUsuario", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ActividadUsuario_Usuario_UsuarioId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsuarioEmail = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    UsuarioTelefono = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    FechaPedido = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FechaEntrega = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Gramos = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Gramajes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Gramajes_Producto_ProductoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsuarioId = table.Column<int>(type: "int", nullable: false),
                    ProductoId = table.Column<int>(type: "int", nullable: false),
                    GramajeId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Carrito_Gramajes_GramajeId",
                        column: x => x.GramajeId,
                        principalTable: "Gramajes",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GramajeId = table.Column<int>(type: "int", nullable: true),
                    GramajeSeleccionado = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    Cantidad = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DetallePedidos_Gramajes_GramajeId",
                        column: x => x.GramajeId,
                        principalTable: "Gramajes",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActividadUsuario_UsuarioId",
                table: "ActividadUsuario",
                column: "UsuarioId");

            migrationBuilder.CreateIndex(
                name: "IX_Carrito_GramajeId",
                table: "Carrito",
                column: "GramajeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetallePedidos_GramajeId",
